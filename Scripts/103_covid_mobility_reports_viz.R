...
## AUTHOR:  A Chafetz & Tim Essam | USAID
...
# LOAD AND MUNGE ----------------------------------------------------------
  ...
  mobility <- read_csv("../../../Downloads/Global_Mobility_Report(1).csv")
...
# PLOT AND LABEL ----------------------------------------------------------
  ...
  mobility_zmb %>% 
    ...
    annotate("rect", xmin = as.Date("2020-07-01"), xmax = as.Date("2020-10-01"), ymin = -Inf, ymax = Inf, alpha = 0.55, fill= grey10k) +
